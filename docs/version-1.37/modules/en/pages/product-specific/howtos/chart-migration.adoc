...
= Migration from community three-chart setup
...
[source,sh]
----
helm uninstall kubewarden-defaults -n "$SOURCE_NAMESPACE"
helm uninstall kubewarden-controller -n "$SOURCE_NAMESPACE"
helm uninstall kubewarden-crds -n "$SOURCE_NAMESPACE"
----
